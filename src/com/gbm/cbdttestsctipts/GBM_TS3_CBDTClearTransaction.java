...
public class GBM_TS3_CBDTClearTransaction {
	...
	@Test
	public static void CBDTClearingTransaction() 
	{
		try
		{
			...
			//report fail
			if (!bStatus){
				Reporting.logResults("Fail", "Create a Zone for Clear transaction ", "Failed to create zone. Error Message:" + Messages.errorMsg + Messages.appErrorMsg);
				Assert.fail("Failed to create zone.Error Message:" + Messages.errorMsg+Messages.appErrorMsg);
			}

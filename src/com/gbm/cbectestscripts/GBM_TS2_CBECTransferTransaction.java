...
public class GBM_TS2_CBECTransferTransaction {
	...
	@Test (description="Creates and validates the CBEC - Transfer transaction mode")
	public static void CBECTransferTransaction() 
	{
		try
		{
			...
			// Create CBEC Transfer transaction by entering data in all mandatory fields

...
public class GBM_TS1_NPS_CashTransaction {
	...
	@Test (description="Creates and validates the NPS - Cash transaction mode")
	public static void NPScashTransaction() 
	{
		try
		{
			...
			Reporting.logResults("Pass", " Navigate to NPS page.","NPS page is opened to create new transaction.");
			...
			Reporting.logResults("Pass", " Navigate to NPS page to verify cash transaction.","NPS page is opened to verify cash transaction.");

			// Verify the NPS- Cash transaction
	...
	public static void closeBrowser()
	{
		...
		if(!bStatus)
			...
			Reporting.logResults("Pass", "Logout from  application", "Cheker successfully logged out from application");

...
public class GBM_TS2_NPS_TransferTransaction {
	...
	@Test (description="Creates and validates the NPS - Tranfer transaction mode")
	public static void NPScashTransaction() 
	{
		try
		{
			...
			Reporting.logResults("Pass", " Navigate to NPS Page.","NPS Page is Opened.");
			...
			// Verify the NPS- Tranfer transaction

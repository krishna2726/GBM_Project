...
public class GBM_TS14_IntersolPPFDepositTransfer {
	public static boolean bStatus;

	protected static String sGBMTempPath = Global.sGBMTempTestDataPath;
	protected static String sGBMTestDataFilepath = "";
	protected static String sTestCaseName = "PPF_INTERSOL_DEPOSIT_TRANSFER_TC14";
	...
	@Test (description="Creates and validates the PPF - Intersol Deposit Transfer")
	public static void intersolPPFDepositTransfer() 
	{
		try
		{

...
public class GBM_TS16_IntersolPPFClearingReconciliation {
	public static boolean bStatus;

	protected static String sGBMTempPath = Global.sGBMTempTestDataPath;
	protected static String sGBMTestDataFilepath = "";
	protected static String sTestCaseName = "PPF_INTERSOL_DEPOSIT_ClearReconcile_TC16";
	protected static Map<String, String> objTransactionDetails = null;
	public static String sSheetName = "Intersol_PPF";
	...
	@Test (description="Intersol_PPF_Clearing_reconciliation")
	public static void Intersol_PPF_Clearing_reconciliation() 
	{
		try
		{

...
public class GBM_TS8_PPF_ClearingReconciliation {
	public static boolean bStatus;
	protected static String sGBMTempPath = Global.sGBMTempTestDataPath;
	protected static String sGBMTestDataFilepath = "";
	protected static String sTestCaseName = "PPF_DEPOSIT_ClearingReconcile_TC8";
	...
	@Test (description="Creates PPF - Clearing Recounciliation ")
	public static void PPFClearing_Recouncilation_Transaction() 
	{
		try
		{

...
public class GBM_TS3_SalesTaxClearTransaction {
	...
	@Test (description="Creates and validates the Sales Tax - Clearing transaction mode")
	public static void SalesTaxClearingTransaction() 
	{
		try
		{
